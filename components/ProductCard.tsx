            ...
            <div className="flex gap-4">
                ...
                <div className="flex-1 flex flex-col justify-between min-w-0 py-0.5">
                    ...
                    <div className="flex items-center justify-between mt-3">
                        ...
                        <div className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center text-primary shadow-sm border border-primary/20 group-hover:bg-primary group-hover:text-white transition-colors">
