        ...
        <div className="flex bg-slate-900 p-1.5 rounded-2xl border border-slate-800 shadow-xl shadow-black/20 sticky top-24 z-30">
          {TABS.map(tab => (
            <button
              ...
              className={`flex-1 flex items-center justify-center gap-2 py-3 text-sm font-semibold rounded-xl transition-all duration-300 ${activeTab === tab.id
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-6">
                {FRAMES.map((frame) => (
                  <button
                    ...
                    className={`relative flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border transition-all duration-300 group overflow-hidden ${frameStyle === frame.id
      ...
      <div className="lg:col-span-5">
        <div className="sticky top-28 space-y-6">
          <div className="bg-gradient-to-br from-slate-200 to-slate-300 rounded-3xl p-8 shadow-2xl flex flex-col items-center justify-center min-h-[500px] border-4 border-slate-800">
            ...
            {/* PREVIEW CONTAINER */}
            <div className={`relative transition-all duration-300 flex flex-col items-center ${frameStyle === 'acrylic' ? 'p-8 rounded-xl shadow-2xl border border-white/40' :
            ...
            >
              ...
              {frameStyle === 'polaroid' && (
                <div className="mt-4 text-center">
                  <h2 className="font-serif font-bold text-slate-800">{restaurantName}</h2>
