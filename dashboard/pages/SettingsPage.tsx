  ...
  return (
    <SectionCard title="Misafir Bilgi Toplama">
      <p className="text-sm text-text-muted">
        Menüye erişmeden önce müşterilerden hangi bilgilerin toplanacağını ayarlayın.
      </p>
        ...
        <div key={field} className="flex items-center justify-between py-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="relative w-10 h-5 rounded-full bg-primary transition-colors">
              <span className="absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white shadow translate-x-5 transition-transform" />
            </button>
          </div>
        </div>
      ))}
...
function QRCodeSection() {
  return (
    <SectionCard title="QR Kod Oluşturucu">
      <p className="text-sm text-text-muted">
        Restoranınız için özel QR kodlar oluşturun ve indirin.
      </p>
      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-lg">
        <code className="text-sm text-text flex-1 truncate">
          https://menu.kozbeylikonagi.com
        </code>
        <button className="p-1.5 rounded hover:bg-gray-200 text-text-muted transition-colors">
          <Copy size={15} />
        </button>
        <button className="p-1.5 rounded hover:bg-gray-200 text-text-muted transition-colors">
      ...
      <div className="flex gap-3">
        ...
        <button className="flex items-center gap-2 border border-border text-text px-5 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors">
          <Download size={16} />
          SVG İndir
        </button>
      </div>
...
function AIChatSection() {
  return (
    <SectionCard title="AI Sohbet Botu Ayarları">
      <p className="text-sm text-text-muted">
        Müşterileriniz için AI destekli sohbet botunu yapılandırın.
      </p>
      ...
      <div>
        ...
        <textarea
          defaultValue="Kozbeyli Konağı'nın yardımcı asistanı olarak, menü hakkında bilgi verin. Nazik ve profesyonel olun."
          rows={3}
...
function PDFSection() {
  return (
    <SectionCard title="PDF Menü İndirme">
      <p className="text-sm text-text-muted">
        Menünüzün PDF versiyonunu oluşturun ve indirin.
      </p>
      ...
      <button className="flex items-center gap-2 border border-border text-text px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors w-full justify-center">
        <FileText size={16} />
        PDF Yeniden Oluştur
      </button>
    </SectionCard>
...
function BillingSection() {
  return (
    <SectionCard title="Plan & Faturalandırma">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-text-muted mt-0.5">
              Aylık faturalandırma • Sonraki ödeme: 15 Şubat 2025
            </p>
          </div>
      ...
      <div className="flex gap-3">
        <button className="flex-1 flex items-center justify-center gap-2 border border-border text-text px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors">
          Planı Değiştir
        </button>
        <button className="flex-1 flex items-center justify-center gap-2 border border-border text-text px-4 py-2.5 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors">
          <CreditCard size={16} />
