...
const PRODUCTS = [
    { id: 'k1', title: 'Gurme Serpme Kahvaltı', description: 'Sahanda tereyağlı sucuklu yumurta, domates, salatalık, yeşil biber, roka, avokado, siyah zeytin, Hatay kırma zeytin, çeşitli peynirler, ceviz ve mevsim meyveleri içeren zengin bir serpme kahvaltı sunumu.', price: 650, category_id: 'kahvalti', is_active: true, image: 'https://images.unsplash.com/photo-1544436856-78e9b6a6df2e?auto=format&fit=crop&q=80', allergens: ['gluten', 'dairy', 'egg'], labels: ['popular'], preparation_time: 20, calories: 1250 },
    { id: 'e1', title: '2 Adet Fransız Tereyağlı Kruvasan', description: 'Kat kat açılan hamurun tereyağı ile harmanlanmasıyla yapılan klasik fransız kruvasan.', price: 300, category_id: 'ekstralar', is_active: true, image: 'https://images.unsplash.com/photo-1555507036-ab1f4038808a?auto=format&fit=crop&q=80', allergens: ['gluten', 'dairy'], labels: ['new'], preparation_time: 5, calories: 450 },
    { id: 'e6', title: 'Mıhlama', description: 'Karadeniz mutfağının ünlü mısır unu ve peynirle hazırlanan sıcak yemeği.', price: 400, category_id: 'ekstralar', is_active: true, image: 'https://images.unsplash.com/photo-1638258673898-1e43343606f2?auto=format&fit=crop&q=80', allergens: ['dairy', 'gluten'], labels: ['popular'], preparation_time: 15, calories: 650 },
    { id: 'b1', title: 'Başlangıç Tabağı', description: 'Zeytin, zahter, zeytinyağı ve fesleğenli domatesli ciabatta ekmeği içeren lezzetli bir atıştırmalık tabağı.', price: 350, category_id: 'baslangic', is_active: true, image: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?auto=format&fit=crop&q=80', allergens: ['gluten'], labels: ['popular'], preparation_time: 10, calories: 450 },
    { id: 'p3', title: 'Taş Fırın Margarita Pizza', description: 'Taş fırında pişirilmiş, taze roka, parmesan peyniri ve acılı zeytinyağı ile sunulan geleneksel bir Margarita Pizza.', price: 500, category_id: 'pizza-sandvic', is_active: true, image: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?auto=format&fit=crop&q=80', allergens: ['gluten', 'dairy'], labels: ['popular'], preparation_time: 15, calories: 850 },
    { id: 'ay1', title: 'Izgara Pirzola', description: 'Izgarada pişirilen kemikli et dilimleri. Patates püresi tabanı ve kavrulmuş file badem ile servis edilir.', price: 1000, category_id: 'ana-yemek', is_active: true, image: 'https://images.unsplash.com/photo-1544025162-d76690b67f14?auto=format&fit=crop&q=80', allergens: [], labels: ['popular'], preparation_time: 25, calories: 1100 },
    { id: 'ay5', title: 'Izgara Levrek', description: 'Taze günlük levrek, kömür ateşinde ızgara edilir. Yanında roka, kırmızı soğan ve fırın patates ile servis edilir.', price: 950, category_id: 'ana-yemek', is_active: true, image: 'https://images.unsplash.com/photo-1594041680534-e8c8cdebd659?auto=format&fit=crop&q=80', allergens: [], labels: ['new'], preparation_time: 30, calories: 450 },
    { id: 't2', title: 'Antakya Künefe', description: 'Geleneksel bir Türk tatlısı. İncecik tel kadayıf arasında eriyen peynir ve şerbetiyle sıcak servis edilir.', price: 350, category_id: 'tatli', is_active: true, image: 'https://images.unsplash.com/photo-1594520771801-b552b96c8c4c?auto=format&fit=crop&q=80', allergens: ['gluten', 'dairy'], labels: ['popular'], preparation_time: 15, calories: 750 },
    { id: 'e10', title: 'Sahanda Menemen', description: 'Domates, biber ve yumurta ile hazırlanan geleneksel bir Türk kahvaltı lezzeti.', price: 300, category_id: 'ekstralar', is_active: true, image: 'https://images.unsplash.com/photo-1590412200988-a436970781fa?auto=format&fit=crop&q=80' },
    ...
    { id: 'e12', title: 'Sahanda Sucuklu Yumurta', description: 'Sucuk dilimleri ve yumurta ile hazırlanan, tavada tereyağı ile pişirilerek servis edilen doyurucu bir kahvaltı yemeği.', price: 350, category_id: 'ekstralar', is_active: true, image: 'https://images.unsplash.com/photo-1525351484163-7529414395d8?auto=format&fit=crop&q=80' },
